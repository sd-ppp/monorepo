...
export function registerThumbnailAction(context) {
    const { mcpMesh } = context;
    mcpMesh.implementAction("fileResource.thumbnail", async (params) => {
        try {
...
//# sourceMappingURL=register-get-thumbnail.js.map