...
export function registerSaveAsAction(context) {
    const { mcpMesh } = context;
    mcpMesh.implementAction("fileResource.saveAs", async (params) => {
        try {
            ...
            for (const resourceId of resources) {
                ...
                try {
                    ...
                    const fallbackName = typeof resourceEntry?.originalMeta?.fileName === "string"
...
//# sourceMappingURL=register-request-save-image.js.map