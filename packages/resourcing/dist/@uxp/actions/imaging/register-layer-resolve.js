import { buildContentUri, buildMaskContentUri, parseContentResource, parseMaskResource } from "../../../resource-uris.js";
import { getCurrentLayerIdentify } from "@sdppp/ps-uxp/src/mesh/actions/photoshop-impls/getCurrentLayerIdentify";
export function registerLayerResolveAction(context) {
    const { mcpMesh } = context;
    mcpMesh.implementAction("layer.resolve", async (params) => {
        try {
            if (!params?.uri) {
...
//# sourceMappingURL=register-layer-resolve.js.map